...
import {navLinks} from '../config.jsx';
import {loaderDelay} from '../utils/index.jsx';
import {usePrefersReducedMotion, useScrollDirection} from '../hooks';
import {Menu} from './index.jsx';
import {Link} from "@reach/router";
import {IconLogo} from "./icons/index.jsx";
...
const Nav = ({isHome}) => {
    ...
    const Logo = (<div className="logo" tabIndex="-1">
        {isHome ? (<a href="/" aria-label="home">
    ...
    return (<StyledHeader scrollDirection={scrollDirection} scrolledToTop={scrolledToTop}>
        <StyledNav>
            {prefersReducedMotion ? (<>
                ...
                <StyledLinks>
                    <ol>
                        {navLinks && navLinks.map(({url, name}, i) => (<li key={i}>
